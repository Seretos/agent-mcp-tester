# PyInstaller spec for the agent-mcp-tester MCP server.
#
...
# Output:   dist/mcp-tester.exe on Windows, dist/mcp-tester on Linux
# Copy to:  bin/mcp-tester(.exe)  (handled by scripts/build.ps1)
